...
PEA <- wtd.table(x = data$v0805, y = data$v0501, weights = data$v9991, normwt = FALSE, na.rm = TRUE, na.show = FALSE)
# PIA <- wtd.table(x = data$v0805 , weights = data$v9991, normwt = FALSE, na.rm = TRUE, na.show = FALSE)
